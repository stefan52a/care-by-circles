...
const _AliceId = 'Alice+31-6-233787929zc'
...
const _BobId = 'Bob+31-6-231610011zc'
...
const _CharlieId = 'Charlie+31-6-231231391zc'
                                                ...
                                                letJoin(AlicePubkey, CharliePubkey, _CharlieId, _saltCharlie, circles[0].instanceCircles, newUTXOAlice, false, (dummy, err) => {
                                                    ...
                                                    letJoin(AlicePubkey, CharliePubkey, _CharlieId, _saltCharlie, circles[0].instanceCircles, newUTXOAlice, true, (dummy, err) => {
                                                        if (err) {
                                                            ...
                                                            //     letJoin(AlicePubkey, CharliePubkey, CharlieId, _saltCharlie, circles[0].instanceCircles, newUTXOAlice, true, (dummy, err) => {
                                                            //         if (err) {
                                                            //             console.log("======>when a Circle already has 150 members, which should fail")
                                                            //             console.log((i+3)+"\n"+dummy)
                                                            //             console.log("======>failed successfully")
