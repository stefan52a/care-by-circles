...
// Specify timeout
module.exports.contract = (circleId, BobId, salt, callback) => { console.log("tralala");
    const dunbarsNumber = 150;
    ID.checkExists(BobId, salt, (result, err) => { console.log("tralala");
        ...
        lock.acquire(circleId, function(done) { /// we donot want the concurrency problem that 2 or more pocesses check wheter total member of a Circle are > 150, whereby you possibly can exceed 150
            // async work
            ID.inThisGenesisCircle(circleId, BobId, salt, (Circle, nrOfMembers, fault) => { console.log("tralala");
