...
module.exports.contract = (circleId, BobId, salt, callback) => {
    ...
    ID.checkExists(BobId, salt, (result, err) => {
        ...
        lock.acquire(key, function (error, ret) { /// we donot want the concurrency problem that 2 or more pocesses check wheter total member of a Circle are > 150, whereby you possibly can exceed 150
            ...
            return callback("400", { error: err.message + err });
        });
    });
}
